...
public class IPSeeker {
    ...
    public static void main(String[] args) {
        IPSeeker ipSearch = IPSeeker.getInstance();
        System.out.println(ipSearch.getAddress("192.168.1.1"));
        System.out.println(ipSearch.getCountry("113.2.47.240"));
        System.out.println(ipSearch.getArea("113.2.47.240"));
    }
}
